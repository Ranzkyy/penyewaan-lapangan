...
<div class="flex bg-[#F8DFD4]">
    ...
    <div class="w-full">
        ...
        <div class="flex justify-around">
            ...
            <div class="bg-green-600 h-28 rounded-lg w-56 place-content-center items-center grid transition-transform transform hover:scale-110 shadow-2xl">
                <h1 class="text-white font-bold text-xl">QR Codes</h1>
                <h1 class="text-center text-white text-4xl font-extrabold">{{$qrCodes}}</h1>
            </div>
        </div>
    </div>
