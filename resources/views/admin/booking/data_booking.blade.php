...
@section('konten')
    <div class="flex">
        ...
        <div class="w-full ml-64 bg-[#F8DFD4] min-h-screen">
            ...
            <div class="pl-10 pt-10 flex justify-between pr-10">
                <div class="flex gap-3">
                    ...
                    <button class="bg-[#C69774] py-3 px-3 rounded-lg text-white font-bold hover:bg-blue-600 transition duration-500"
                        id="printButton">
                        Cetak
                    </button>
                    <button class="bg-[#C69774] py-3 px-3 rounded-lg text-white font-bold hover:bg-blue-600 transition duration-500"
                ...
                <div class="relative">
                    <form action="{{ route('admin_booking') }}" method="GET" class="flex gap-2">
                        <input
                            type="text"
                            name="search"
                            value="{{ request('search') }}"
                            placeholder="Cari berdasarkan nama..."
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#C69774] transition duration-300"
                        >
